...
1. **Search widget** — drag+snap, mejora navegación entre bins
2. **Paquetes npm modal** — permite que el JS runner cargue dependencias externas
3. **Tips widget en editor** — icono 💡 en status bar + widget flotante
